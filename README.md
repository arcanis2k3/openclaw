...
> **Fork Notice:** This version of OpenClaw includes a custom feature to unconditionally intercept and log incoming media and text messages (such as from WhatsApp) directly into user-specific subfolders (`~/incoming-media/<channel>/<user>`). This bypasses standard allowlist restrictions to guarantee all inbound messages and media are captured and structured.
